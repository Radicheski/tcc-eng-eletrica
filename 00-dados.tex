...
%----------------------------------------------------------------------------- 
 ...
 \providecommand{\terSumario}{Nao}
 \providecommand{\terAnexo}{Nao}
 \providecommand{\terApendice}{Nao}
 \providecommand{\terIndiceR}{Nao}
%----------------------------------------------------------------------------- 

\titulo{Construção de um Circuito para Teste de Baterias com Estimação em Tempo Real da Resistência Interna}
\autor{GRR20167014 \\ Erik Radicheski da Silva}
\local{Curitiba}
\data{2025} %Apenas ano 4 dígitos

% Orientador ou Orientadora
\orientador{Prof. Luis Henrique Assumpção Lolis, Ph. D.}
...
\def \ImprimirCurso{%
Curso de Engenharia Elétrica \\ Ênfase em Sistemas Eletrônicos Embarcados}%
%Curso de Engenharia Civil}

\preambulo{
Plano de trabalho complementar à matrícula na disciplina TCC I do curso de Engenharia Elétrica do Setor de Tecnologia da Universidade Federal do Paraná}
